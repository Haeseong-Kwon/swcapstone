...
const TeamCard = memo(({ post, index }: { post: TeamBuildingPost; index: number }) => (
  ...
  >
    <Card className="p-8 h-full border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all group gpu-accelerated bg-white dark:bg-slate-900">
