...
const ProfileCard = memo(({ user, index }: { user: User; index: number }) => (
  ...
  >
    <Card className="p-6 h-full border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group gpu-accelerated bg-white dark:bg-slate-900">
      {/* Status Badge */}
